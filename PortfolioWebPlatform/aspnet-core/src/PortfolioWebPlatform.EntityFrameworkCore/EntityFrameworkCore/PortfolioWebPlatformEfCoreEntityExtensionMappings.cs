...
public static class PortfolioWebPlatformEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PortfolioWebPlatformModuleExtensionConfigurator CLASS (in the Domain.Shared project)
